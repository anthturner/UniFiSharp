...
{
    public partial class NetworkDevice : IMessageBase
    {
        [JsonProperty("_id")]
        ...
        public ConfigNetwork config_network { get; set; }

        [JsonProperty("config_network_wan")]
        public ConfigNetwork config_network_wan { get; set; }
        ...
        public IList<EthernetTable> ethernet_table { get; set; }
        ...
        public IList<NetworkTable> network_table { get; set; }
        ...
        public IList<PortTable> port_table { get; set; }
        ...
        public SpeedtestStatus speedtest_status { get; set; }
        ...
        public IList<Link> downlink_table { get; set; }
        ...
        public Link last_uplink { get; set; }
        ...
        public RadioTable radio_na { get; set; }

        [JsonProperty("radio_ng")]
        public RadioTable radio_ng { get; set; }
        ...
        public IList<VapTable> vap_table { get; set; }
        ...
        public IList<PortOverride> port_overrides { get; set; }
        ...
        public class PortTable
        {
            ...
            public IList<MacTable> mac_table { get; set; }
            ...
            public IList<LldpTable> lldp_table { get; set; }
        ...
        public class SysStats
        {
            ...
            public string loadavg_1 { get; set; }

            [JsonProperty("loadavg_15")]
            public string loadavg_15 { get; set; }

            [JsonProperty("loadavg_5")]
            public string loadavg_5 { get; set; }
